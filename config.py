...
def config_parser():
    ...
    # surgical tool weighting
    parser.add_argument('--tool_mask_dir', type=str, default=None, help='the directory of the tool masks')
    parser.add_argument('--tool_factor', type=float, default=10., help='factor for tool weighting')
